/* ============================================================
   ...
   Bu faylni tahrirlab, o'z sexingizning haqiqiy ma'lumotlarini
   kiriting. Har bir massiv pastda tushuntirilgan tuzilishga ega.
   ============================================================ */

/* 1) XODIMLAR — sex shtati bo'yicha */
const XODIMLAR = [
  { ism: "Baxtiyor Qodirov",   lavozim: "Sex boshlig'i",        toifa: "Oliy toifa",  staj: "14 yil" },
  { ism: "Sardor Yusupov",     lavozim: "Bosh usta",            toifa: "1-toifa",     staj: "9 yil"  },
...
/* 2) KUTUBXONA — elektron kitoblar / texnik hujjatlar
   Ixtiyoriy `havola` maydoni: PDF manzilini qo'shsangiz, karta bosiladigan
   havolaga aylanadi. Masalan: havola: "kitoblar/payvandlash.pdf" */
const KITOBLAR = [
...
/* 3) DARSLIKLAR — o'quv mashg'ulotlari uchun materiallar
   Bu yerda ham `havola` maydoni qo'llab-quvvatlanadi. */
const DARSLIKLAR = [
...
/* 4) TESTLAR — bilim sinash uchun. Har bir savolda 'togri' — variantlar[] ichidagi to'g'ri javob indeksi (0 dan boshlanadi) */
const TESTLAR = [
  {
